...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: { title: p.nombre, description: p.descripcion },
  };
}
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-3 flex items-center gap-2 text-sm">
            ...
            <span className="text-zinc-500">({p.reviews} reseñas)</span>
          ...
          <div className="mt-6 rounded-2xl border border-zinc-200 bg-white p-5">
            ...
            <p className="mt-1 text-xs text-zinc-500">
              o paga en cuotas con tu tarjeta
            </p>
          ...
          <div className="mt-6">
            ...
            <dl className="mt-3 divide-y divide-zinc-200 rounded-xl border border-zinc-200">
              {Object.entries(p.specs).map(([key, value]) => (
                ...
                >
                  <dt className="font-semibold capitalize text-zinc-600">
                    {key.replace(/([A-Z])/g, " $1")}
                  </dt>
